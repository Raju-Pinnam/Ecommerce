...
class LoginForm(forms.Form):
    username = forms.EmailField(label='User ID',widget=forms.EmailInput(attrs={
        'class': 'form-control',
...
class RegisterForm(forms.Form):
    ...
    name = forms.CharField(label='Username',widget=forms.TextInput(attrs={
        'class': 'form-control',
    ...
    def clean(self):
        ...
        if 'gmail.com' not in email:
            ...
            if qs.exists():
                raise forms.ValidationError('Useremail already exists')
